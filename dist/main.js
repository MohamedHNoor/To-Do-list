...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _css_style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./css/style.css */ \"./src/css/style.css\");\n/* harmony import */ var _modules_variables_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/variables.js */ \"./src/modules/variables.js\");\n/* harmony import */ var _modules_functionality_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/functionality.js */ \"./src/modules/functionality.js\");\n\n\n\n\n\n// select elements\n\n// form submit\n_modules_variables_js__WEBPACK_IMPORTED_MODULE_1__.form.addEventListener('submit', (Event) => {\n  Event.preventDefault();\n  (0,_modules_functionality_js__WEBPACK_IMPORTED_MODULE_2__.addTodo)();\n  (0,_modules_functionality_js__WEBPACK_IMPORTED_MODULE_2__.renderTodo)();\n  localStorage.setItem('TODO', JSON.stringify(_modules_functionality_js__WEBPACK_IMPORTED_MODULE_2__.todoArr));\n});\n\n// Click event listener for all todos\n_modules_variables_js__WEBPACK_IMPORTED_MODULE_1__.todolistContainer.addEventListener('click', (event) => {\n  const { target } = event;\n  const parentElement = target.parentNode;\n\n  if (parentElement.className !== 'list') return;\n\n  // todo id\n  const todo = parentElement;\n  const todoId = Number(todo.id);\n\n  // target action\n  const { action } = target.dataset;\n\n  if (action === 'edit') (0,_modules_functionality_js__WEBPACK_IMPORTED_MODULE_2__.editTodo)(todoId);\n  if (action === 'delete') (0,_modules_functionality_js__WEBPACK_IMPORTED_MODULE_2__.deleteTodo)(todoId);\n});\n\n_modules_variables_js__WEBPACK_IMPORTED_MODULE_1__.clearAll.addEventListener('click', () => {\n  (0,_modules_functionality_js__WEBPACK_IMPORTED_MODULE_2__.completeTodo)();\n});\n\n_modules_variables_js__WEBPACK_IMPORTED_MODULE_1__.todolistContainer.addEventListener('change', (event) => {\n  const { target } = event;\n  const parentElement = target.parentNode;\n  if (!parentElement.classList.contains('list')) return;\n  const todoId = Number(parentElement.id);\n  // target the data action\n  const { action } = target.dataset;\n\n  if (action === 'checkbox') {\n    (0,_modules_functionality_js__WEBPACK_IMPORTED_MODULE_2__.checkTodo)(todoId, target);\n    (0,_modules_functionality_js__WEBPACK_IMPORTED_MODULE_2__.checkValue)(target);\n  }\n});\n\nwindow.addEventListener('DOMContentLoaded', _modules_functionality_js__WEBPACK_IMPORTED_MODULE_2__.renderTodo);\n\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
